...
export default function App() {
  ...
  return (
    <div className="portfolio-root">
      ...
      <header className="portfolio-header">
        <div className="nav-container">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <a 
              href="https://github.com/rajmohit21/Finflow-Loan-Management-System" 
              target="_blank" 
              rel="noreferrer"
      ...
      {/* HERO SECTION */}
      <section id="home" className="section-padding" style={{ paddingTop: '9rem', paddingBottom: '4rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '3rem', alignItems: 'center' }}>
          <div>
            ...
            <p style={{ fontSize: '1.15rem', color: 'var(--text-muted)', lineHeight: 1.6, marginBottom: '2rem', maxWidth: '540px' }}>
              Computer Science Engineer building scalable <strong style={{ color: 'var(--text-main)' }}>Spring Boot microservices</strong>, high-performance <strong style={{ color: 'var(--text-main)' }}>Angular & React interfaces</strong>, and robust cloud deployment architectures.
            </p>

            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', marginBottom: '2.5rem' }}>
              <a href="#projects" className="btn-primary-portfolio">
                <i className="bi bi-folder-symlink-fill"></i> View Featured Projects
              </a>
              <a href="https://github.com/rajmohit21/Finflow-Loan-Management-System" target="_blank" rel="noreferrer" className="btn-secondary-portfolio">
                <i className="bi bi-file-earmark-arrow-down-fill"></i> Explore Source Code
              </a>
            </div>
          ...
          <div className="portfolio-card" style={{ background: 'var(--bg-surface)', fontFamily: 'var(--font-code)', fontSize: '0.88rem', border: '1px solid var(--border-glow)' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.75rem', marginBottom: '1rem' }}>
              ...
              <span style={{ color: 'var(--text-muted)', fontSize: '0.75rem' }}>developer-profile.ts</span>
            </div>
...
{`const developer = {
  ...
  skills: [
    ...
    "Angular 21", "React", "TypeScript",
    "Docker", "MySQL", "Vercel", "REST APIs"
  ],
  primaryProject: "FinFlow Loan System",
  location: "India",
  status: "Available for Software Engineering Roles"
      ...
      <section id="about" className="section-padding" style={{ background: 'var(--bg-surface)', borderTop: '1px solid var(--border-color)', borderBottom: '1px solid var(--border-color)' }}>
        <div className="section-title-badge"><i className="bi bi-person-badge-fill"></i> About Me</div>
        <h2 className="section-heading">Engineering Scalable Systems</h2>
        <p className="section-subheading">A passionate Computer Science student and Full-Stack Developer with expertise in enterprise Java architectures and dynamic web platforms.</p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
          <div className="portfolio-card">
            ...
            <h3 style={{ fontSize: '1.2rem', fontWeight: 700, marginBottom: '0.5rem' }}>Backend Architecture</h3>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.92rem' }}>
              Proficient in Java 17, Spring Boot 3, Spring Cloud microservices (Netflix Eureka, API Gateway, Config Server), Spring Security, and RESTful API engineering.
            </p>
          </div>
          ...
          <div className="portfolio-card">
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.92rem' }}>
              Extensive hands-on experience building Single Page Applications (SPAs) with Angular & React, featuring reactive state management, dark mode design systems, and responsive layouts.
            </p>
          </div>
          ...
          <div className="portfolio-card">
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.92rem' }}>
              Skilled in Docker, Docker Compose multi-container orchestration, Vercel static deployments, environment variable security, and CI/CD pipelines.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
          ...
          <div className="portfolio-card">
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.6rem' }}>
              ...
              <span className="skill-tag"><i className="bi bi-check2-circle text-info"></i> React</span>
              ...
              <span className="skill-tag"><i className="bi bi-check2-circle text-info"></i> Tailwind CSS</span>
            </div>
          </div>
          ...
          <div className="portfolio-card">
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.6rem' }}>
              ...
              <span className="skill-tag"><i className="bi bi-check2-circle text-primary"></i> Spring Cloud</span>
              <span className="skill-tag"><i className="bi bi-check2-circle text-primary"></i> Eureka Registry</span>
              <span className="skill-tag"><i className="bi bi-check2-circle text-primary"></i> API Gateway</span>
              <span className="skill-tag"><i className="bi bi-check2-circle text-primary"></i> Config Server</span>
              <span className="skill-tag"><i className="bi bi-check2-circle text-primary"></i> JWT Security</span>
            </div>
          </div>
          ...
          <div className="portfolio-card">
            <h3 style={{ fontSize: '1.1rem', fontWeight: 700, marginBottom: '1.25rem', color: 'var(--accent-emerald)' }}>
              <i className="bi bi-database-fill-gear me-2"></i> Databases & Cloud DevOps
            </h3>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.6rem' }}>
              <span className="skill-tag"><i className="bi bi-check2-circle text-success"></i> MySQL 8.0</span>
              <span className="skill-tag"><i className="bi bi-check2-circle text-success"></i> Docker & Compose</span>
              <span className="skill-tag"><i className="bi bi-check2-circle text-success"></i> RabbitMQ</span>
      ...
      <section id="projects" className="section-padding" style={{ background: 'var(--bg-surface)', borderTop: '1px solid var(--border-color)' }}>
        ...
        <h2 className="section-heading">Featured Enterprise Project</h2>
        <p className="section-subheading">Production-ready, microservices-based loan management system built to industry standards.</p>
        ...
        <div className="portfolio-card" style={{ border: '2px solid var(--accent-blue)', background: 'var(--bg-card)', padding: '2.5rem' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem', marginBottom: '1.5rem' }}>
            <div>
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '1rem', maxWidth: '750px' }}>
                An enterprise-grade, multi-tenant digital loan application & underwriting platform powered by Spring Cloud microservices, Angular 21, and MySQL. Supports real-time document verification, EMI calculation, profile isolation, and dark mode.
              </p>
            </div>

            <div style={{ display: 'flex', gap: '0.75rem' }}>
              <a href="https://github.com/rajmohit21/Finflow-Loan-Management-System" target="_blank" rel="noreferrer" className="btn-primary-portfolio">
                <i className="bi bi-github"></i> View GitHub Code
              </a>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1rem', marginBottom: '2rem' }}>
            <div style={{ background: 'var(--bg-surface)', padding: '1rem', borderRadius: '0.75rem', border: '1px solid var(--border-color)' }}>
              <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', textTransform: 'uppercase', fontWeight: 700 }}>Architecture</div>
              <div style={{ fontWeight: 700, fontSize: '0.95rem', color: 'var(--text-main)', marginTop: '0.25rem' }}>Spring Cloud Microservices</div>
            </div>
            <div style={{ background: 'var(--bg-surface)', padding: '1rem', borderRadius: '0.75rem', border: '1px solid var(--border-color)' }}>
              <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', textTransform: 'uppercase', fontWeight: 700 }}>Frontend</div>
              <div style={{ fontWeight: 700, fontSize: '0.95rem', color: 'var(--text-main)', marginTop: '0.25rem' }}>Angular 21 + Reactive Forms</div>
            </div>
            <div style={{ background: 'var(--bg-surface)', padding: '1rem', borderRadius: '0.75rem', border: '1px solid var(--border-color)' }}>
              <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', textTransform: 'uppercase', fontWeight: 700 }}>Service Discovery</div>
              <div style={{ fontWeight: 700, fontSize: '0.95rem', color: 'var(--text-main)', marginTop: '0.25rem' }}>Netflix Eureka Server</div>
            </div>
            <div style={{ background: 'var(--bg-surface)', padding: '1rem', borderRadius: '0.75rem', border: '1px solid var(--border-color)' }}>
              <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', textTransform: 'uppercase', fontWeight: 700 }}>Containerization</div>
              <div style={{ fontWeight: 700, fontSize: '0.95rem', color: 'var(--text-main)', marginTop: '0.25rem' }}>Docker & Docker Compose</div>
            </div>
          </div>

          {/* Features List */}
          <h4 style={{ fontSize: '1rem', fontWeight: 700, marginBottom: '0.75rem', color: 'var(--accent-blue)' }}>Key Technical Capabilities:</h4>
      ...
      <section id="education" className="section-padding">
        ...
        <h2 className="section-heading">Education & Academic Background</h2>
        <p className="section-subheading">Solid foundational computer science education and technical training.</p>
        ...
        <div className="portfolio-card" style={{ maxWidth: '800px' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.6 }}>
            Comprehensive coursework covering Data Structures & Algorithms, Object-Oriented Programming in Java, Database Management Systems (SQL), Web Technologies, Operating Systems, Software Engineering, and Computer Networks.
          </p>
        </div>
      </section>
      ...
      <footer style={{ padding: '2.5rem 1.5rem', textAlign: 'center', borderTop: '1px solid var(--border-color)', color: 'var(--text-muted)', fontSize: '0.9rem' }}>
        <p style={{ fontWeight: 600, color: 'var(--text-main)', marginBottom: '0.5rem' }}>Mohit Raj — Full Stack Engineer</p>
        <p style={{ fontSize: '0.85rem' }}>© 2026 Mohit Raj. Built with React & TypeScript. All rights reserved.</p>
      </footer>
    </div>
  );
}
